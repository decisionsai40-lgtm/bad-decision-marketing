...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" lastUpdated="July 9, 2026">
      ...
      <h3>5.2 Payment</h3>
      <p>
        We use a third-party payment processor to handle all payments and
        currency conversion. Your payment is processed by them under their terms,
        and we never see or store your full card details. Bad Decision is the
      ...
      <p>
        ...
        annually) until you cancel. You can cancel at any time from your billing
        portal. Your subscription stays active until the end of the current period,
        then downgrades to Free.
      </p>

      <h3>5.4 Price Changes</h3>
      <p>
        We may change our prices with at least 30 days' notice. Price changes apply
        to your next renewal. You can cancel before the renewal to avoid the new
        price.
      </p>
      ...
      <p>
        ...
        at checkout depending on your location and our payment processor's tax
        configuration.
      </p>
      ...
      <p>
        ...
        purchase. Community members who supply their own account keys do not consume
        platform credits for the operations those keys cover.
      </p>
      ...
      <p>
        ...
        dependency failures, or events beyond our control. We are not liable for
        any downtime or data loss resulting from such events.
      </p>
      <p>
