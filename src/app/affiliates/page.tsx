...
import { DollarSign, TrendingUp, Users, Copy, ArrowRight } from "lucide-react";
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Join the Bad Decision affiliate program. Earn 20% recurring commissions every month your referrals stay subscribed. Users get 20% off, so everyone wins."
      />
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 space-y-8">
            {[
              ...
              { step: "3", title: "Users get 20% off", desc: "Anyone who signs up via your link gets 20% off their first 3 months. That is a strong reason to click." },
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={f.title} className="card-premium p-6">
                <f.icon className="h-8 w-8 text-gray-900" />
                <h3 className="mt-3 font-extrabold text-gray-900">{f.title}</h3>
                <p className="mt-1 text-sm font-medium text-gray-600">{f.desc}</p>
              </div>
            ))}
          </div>
      ...
      <section className="bg-gray-50 py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl font-extrabold text-gray-900">Affiliate FAQ</h2>
