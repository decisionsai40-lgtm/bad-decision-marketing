/**
 * Skeleton for /integrations/[slug] dynamic route.
 * Matches the layout of the integration detail page.
 */
              ...
              <div className="mt-6 space-y-4">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="flex items-start gap-3">
                    ...
                    <div className="h-5 flex-1 rounded bg-gray-100" style={{ width: `${80 - i * 8}%` }} />
                  </div>
                ))}
              </div>
            </div>
